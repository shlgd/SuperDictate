...
- Чтобы назначить одну другую клавишу или сочетание, откройте SuperDictate,
  нажмите `Change…` рядом с `Dictation shortcut`, запишите сочетание и
  подтвердите его. Фоновая служба перезапустится автоматически.
