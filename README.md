...
По умолчанию сборка из исходников скачивает тег `v0.2.36` и проверяет,
...
```bash
curl -fsSL https://raw.githubusercontent.com/shlgd/SuperDictate/v0.2.36/uninstall.sh | bash
```
