...
- **Правый Command** — начать диктовку или закончить её без Enter.
- **Правый Option + правый Command** — закончить активную диктовку, вставить
  весь текст и только после этого нажать Enter.
- **Правый Shift + правый Command** — открыть или закрыть быструю историю.
- Все три сочетания можно изменить независимо, а отдельное завершение с Enter
  можно полностью выключить. Поддерживаются одиночные клавиши,
...
Шестерёнка открывает отдельное окно с тремя сочетаниями, выключателем Enter,
размером капсулы, цветами и фоном индикатора. Переключатель `RU / EN` мгновенно меняет язык обеих
панелей. Изменения сначала остаются черновиком; кнопка
