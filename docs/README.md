...
- **Оптимизировано под 8 ГБ RAM:** Эффективное управление памятью и освобождение буферов инференса.
- **Плавный интерфейс (ProMotion 120 Гц):** Плавающая капсула записи с аппаратной анимацией звуковой волны.
- **Мультиязычность:** Модель Parakeet TDT v3 с автоопределением языка и поддержкой русского, английского и других языков.

---

## Установить за минуту

**Нужен Mac с Apple Silicon (`M1` или новее, включая A18 Pro) и macOS 14+.**
...
При первом запуске один раз загрузится локальная модель распознавания (~475 МБ).
После загрузки интернет для диктовки не требуется.
...
- [Архитектура и код (CODE_DOCUMENTATION.md)](CODE_DOCUMENTATION.md) — структура модулей, описание слоёв и системных вызовов.
- [Философия и дизайн (DESIGN_PHILOSOPHY.md)](DESIGN_PHILOSOPHY.md) — принципы приватности, оптимизации под 8 ГБ RAM и ANE.
- [Правила разработки (AGENTS.md)](AGENTS.md) — инварианты установки и правил сборки.
